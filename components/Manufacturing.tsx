...
export function Manufacturing() {
  ...
  return (
    <MotionSection
      ...
      className="bg-graphite py-20 md:py-44"
    >
      <div className="section-shell">
        <div className="grid gap-8 md:gap-12 lg:grid-cols-[0.9fr_1fr] lg:items-end">
          ...
          />
          <div className="relative h-[260px] overflow-hidden rounded-md shadow-premium sm:h-[340px] md:h-[390px]">
            <img
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 md:mt-16 md:gap-4 lg:grid-cols-3">
          {t.manufacturing.areas.map(([title, text], index) => (
            <MotionArticle
              ...
              className="group premium-card rounded-md p-5 transition duration-500 hover:-translate-y-2 hover:border-fern/35 hover:bg-white/[0.06] sm:min-h-56 md:min-h-60 md:p-7"
            >
              <div className="flex items-center justify-between gap-4 border-b border-stone/10 pb-5 md:pb-7">
                <h3 className="text-xl font-semibold text-[#f8f8f4] md:text-2xl">{title}</h3>
