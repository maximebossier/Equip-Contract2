  ...
  return (
    ...
    >
      <div className="section-shell">
        ...
        <div className="mt-10 grid gap-4 md:mt-16 md:grid-cols-2 md:gap-5">
          {t.projects.items.map((project, index) => (
            ...
            >
              ...
              <div className="p-6 md:p-8">
                ...
                <h3 className="mt-4 text-2xl font-semibold text-[#f8f8f4] transition group-hover:text-fern md:text-3xl">{project.title}</h3>
