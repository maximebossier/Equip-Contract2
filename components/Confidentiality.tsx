...
export function Confidentiality() {
  ...
  return (
    <MotionSection
      ...
      className="relative overflow-hidden bg-[#0b0e0c] py-20 md:py-44"
    >
      ...
      <div className="section-shell">
        <div className="premium-card relative overflow-hidden rounded-md p-6 shadow-premium md:p-14 lg:p-16">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_0.72fr] lg:items-end">
            <div className="max-w-4xl">
              ...
              <h2 className="mt-4 text-[2.35rem] font-semibold leading-[1.04] text-[#f8f8f4] md:mt-5 md:text-6xl">
                {t.confidentiality.title}
              </h2>
              <p className="mt-8 max-w-2xl text-lg leading-9 text-stone/68">
                {t.confidentiality.text}
              </p>
              <div className="mt-8 grid gap-3 text-sm text-stone/66 md:mt-12 md:grid-cols-3">
            ...
            <div className="relative h-64 overflow-hidden rounded-md border border-stone/10 shadow-premium md:h-80">
              <img
